...
locals {
  tables_audit = {
    "ingestion_master" = { partition_type = null partition_field = null }
    "ingestion_log"      = { partition_type = null partition_field = null }
    "ai_ops_log"         = { partition_type = null partition_field = null }
    "insight_audit_log"  = { partition_type = "DAY", partition_field = "timestamp" }
  }
  tables_raw = {
    "orders_raw"        = { partition_type = null partition_field = null }
    "nyc_taxi_trips_raw" = { partition_type = null partition_field = null }
    "customer_raw"      = { partition_type = "DAY", partition_field = "batch_date" }
    "product_raw"       = { partition_type = "DAY", partition_field = "batch_date" }
  }
  tables_raw_hist = {
    "orders_raw" = {
      partition_type = null
